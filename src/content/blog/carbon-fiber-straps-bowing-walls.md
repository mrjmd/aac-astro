---
title: "Carbon Fiber Straps for Bowing Walls: What They Do and When You Need Them"
...
faqs:
  - question: "How much do carbon fiber straps cost for a bowing wall?"
    answer: "Individual carbon fiber straps typically cost $800 to $1,500 installed, depending on wall height and access. A typical basement wall (20-24 feet long) needs 4 to 6 straps spaced every 4 feet, putting the total cost between $3,200 and $9,000 per wall. This is significantly less than wall anchors ($4,000-$12,000 with excavation) or steel I-beams ($5,000-$15,000)."
  - question: "Can carbon fiber straps fix a wall that is already bowing?"
    answer: "Carbon fiber straps stabilize a bowing wall and prevent it from moving further inward. They do not push the wall back to its original position. For walls with less than 2 inches of inward deflection, straps are the standard repair. For walls bowed more than 2 inches, wall anchors or steel I-beams may be needed because they can apply force to gradually straighten the wall over time."
  - question: "How long do carbon fiber straps last on a foundation wall?"
    answer: "Carbon fiber does not rust, rot, or corrode. Unlike steel reinforcements that degrade in wet basement environments, carbon fiber maintains its full strength indefinitely. The epoxy bond is equally permanent. Most reputable contractors offer a lifetime transferable warranty on carbon fiber strap installations."
  - question: "Do carbon fiber straps work on all types of foundation walls?"
    answer: "Carbon fiber straps work on poured concrete, cinder block (CMU), and brick foundation walls. They are most commonly used on cinder block walls because block walls are the most prone to bowing under lateral soil pressure. Stone and fieldstone foundations may require different approaches because of their uneven surfaces."
  - question: "What is the difference between carbon fiber staples and carbon fiber straps?"
    answer: "Carbon fiber staples (also called stitches) are small reinforcements about 12 inches long that bridge individual cracks. They cost $200 to $300 each and are used when a crack needs to be held together. Carbon fiber straps are much larger — they run the full height of the wall from footing to sill plate. Straps stabilize the entire wall against bowing, not just a single crack. Staples fix cracks. Straps fix walls."
---
...
- **Carbon fiber staples** (also called stitches): Small reinforcements, about 12 inches long, that bridge an individual crack. They hold the two sides of a crack together. Cost: $200–$300 each. Use case: a single crack that needs to stop widening.

- **Carbon fiber straps**: Full-height reinforcements that run from the footing to the sill plate. They stabilize the entire wall against lateral soil pressure. Cost: $800–$1,500 each. Use case: a wall that is bowing inward.

Staples fix cracks. Straps fix walls. They are different tools for different problems. For more on staples, see our [carbon fiber staples guide](/blog/carbon-fiber-staples-vs-stitches).
...
If you see a horizontal crack in your basement wall, or if the wall is visibly bowing inward, get it assessed now. Text us a photo at **617-668-1677** (MA) or **860-573-8760** (CT) — we can often gauge severity from a photo. Or schedule a [free foundation consultation](/services/free-foundation-consultations) and we will measure the deflection and tell you exactly what level of repair your wall needs.

---
title: "Lally Columns: What Every New England Homeowner Should Know"
...
faqs:
  - question: "How much does lally column replacement cost?"
    answer: "A single lally column replacement with an adequate existing footing costs $1,500-$3,000. If a new footing is needed, expect $2,500-$5,000 per column. Multiple column replacements typically run $2,000-$4,000 per column due to economies of scale. If the main beam also needs repair, total costs can reach $5,000-$15,000+."
  - question: "Are adjustable lally columns permanent?"
    answer: "No. Adjustable screw-jack columns are rated as temporary supports only. Most building codes in Massachusetts and Connecticut limit their use to 180 days and do not allow them as permanent structural members. If you have adjustable columns in your basement, they should be evaluated and replaced with permanent concrete-filled columns."
  - question: "What do home inspectors look for with lally columns?"
    answer: "Inspectors check for rust or corrosion (especially at the base), column splitting, hollow construction (code violation), wood or tree trunk supports, deteriorating brick or block, missing cap plates on the beam, and temporary or adjustable columns. Any of these findings can affect a home sale."
  - question: "Can I remove a lally column for an open basement?"
    answer: "Never remove a lally column without a structural engineer's assessment. The column carries load from every floor above. In some cases, an engineer can redesign the support using a larger LVL beam that spans a greater distance, allowing columns to be repositioned or reduced. This requires engineering, permits, and professional installation."
---
